...
class About_Us extends Abstract_Module {
	...
	private function get_about_localization_data() {
		...
		return [
			...
			'strings'        => [
				'aboutUs'          => __( 'About us', 'neve-fse' ),
				'heroHeader'       => __( 'Our Story', 'neve-fse' ),
				...
				'heroTextSecond'   => __( 'At Themeisle, we offer a wide range of WordPress themes and plugins that are designed to meet the needs of both beginners and advanced users. Our products are feature-rich, easy to use, and are designed to help you create beautiful and functional websites.', 'neve-fse' ),
				'teamImageCaption' => __( 'Our team in WCEU2022 in Portugal', 'neve-fse' ),
				'newsHeading'      => __( 'Stay connected for news & updates!', 'neve-fse' ),
				'emailPlaceholder' => __( 'Your email address', 'neve-fse' ),
				'signMeUp'         => __( 'Sign me up', 'neve-fse' ),
				'installNow'       => __( 'Install Now', 'neve-fse' ),
				'activate'         => __( 'Activate', 'neve-fse' ),
				'learnMore'        => __( 'Learn More', 'neve-fse' ),
				'installed'        => __( 'Installed', 'neve-fse' ),
				'notInstalled'     => __( 'Not Installed', 'neve-fse' ),
				'active'           => __( 'Active', 'neve-fse' ),
			],
		];
	}
	...
	private function get_other_products_data() {
		$products = [
			...
			'neve'                                => [
				'skip_api'    => true,
				'name'        => 'Neve',
				'description' => __( 'A fast, lightweight, customizable WordPress theme offering responsive design, speed, and flexibility for various website types.', 'neve-fse' ),
			...
			'wp-landing-kit'                      => [
				...
				'name'        => 'WP Landing Kit',
				'description' => __( 'Turn WordPress into a landing page powerhouse with Landing Kit, map domains to pages or any other published resource.', 'neve-fse' ),
			...
			'sparks-for-woocommerce'              => [
				...
				'name'        => 'Sparks',
				'description' => __( 'Extend your store functionality with 8 ultra-performant features like product comparisons, variation swatches, wishlist, and more.', 'neve-fse' ),
				'icon'        => $this->get_sdk_uri() . 'assets/images/sparks.png',
				'condition'   => class_exists( 'WooCommerce', false ),
			],
			'templates-patterns-collection'       => [
				'name'        => 'Template Cloud',
				'description' => __( 'Ultimate Free Templates Cloud for WordPress, for blocks, patters of full pages.', 'neve-fse' ),
			],
		];
